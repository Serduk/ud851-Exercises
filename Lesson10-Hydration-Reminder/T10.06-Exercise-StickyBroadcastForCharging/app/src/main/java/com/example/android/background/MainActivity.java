...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            batteryStatus.getExtras().getBoolean(BatteryManager.EXTRA_STATUS);
            isCharging = batteryStatus.getStringExtra(BatteryManager.EXTRA_STATUS).equals("BATTERY_STATUS_CHARGING");
        }
