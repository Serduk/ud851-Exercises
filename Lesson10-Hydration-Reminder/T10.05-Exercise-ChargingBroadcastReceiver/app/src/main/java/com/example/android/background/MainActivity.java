...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(chargingBroadCastReceiver, mChargingIntentFilter);
    }
    ...
    private void showCharging(boolean isCharging) {
        if (isCharging) {
            mChargingImageView.setImageResource(R.id.ic_power_ping_80px);
        } else {
            mChargingImageView.setImageResource(R.id.ic_power_grey80px);
        }
